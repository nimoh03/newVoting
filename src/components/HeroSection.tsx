    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <div
            className="fade-in-up grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12"
          ...
          <div className="fade-in-up" style={{ animationDelay: "0.6s" }}>
            <div className="glass-strong rounded-3xl p-8 md:p-12 border border-festival-gold/30 shadow-aurora">
              <p className="text-primary-foreground/95 text-lg md:text-xl leading-relaxed font-medium">
                Join{" "}
                <span className="text-festival-gold font-bold">thousands</span>{" "}
                of young entrepreneurs, innovators, and business leaders as we
                celebrate the entrepreneurial spirit of Oyo State. Experience{" "}
                <span className="text-festival-emerald font-bold">7 days</span>{" "}
                of networking, learning, competitions, and celebration of local
                business excellence.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-festival-emerald">
                    1000+
                  </div>
                  <div className="text-sm text-primary-foreground/80">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-festival-purple">
                    ₦5M
                  </div>
                  <div className="text-sm text-primary-foreground/80">
                    Total Prize Pool
      ...
      <div
        className="absolute top-20 left-10 w-24 h-24 bg-gradient-luxury rounded-full opacity-40 animate-festival-float shadow-glow"
        style={{ animationDelay: "0.5s" }}
      />
      <div
        className="absolute bottom-20 right-10 w-20 h-20 bg-gradient-aurora rounded-full opacity-50 animate-levitate shadow-aurora"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute top-1/2 left-20 w-16 h-16 bg-festival-emerald/40 rounded-full animate-scale-pulse shadow-primary"
